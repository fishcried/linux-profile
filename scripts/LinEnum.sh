...
while getopts "sh:k:r:e:t" option; do
 case "${option}" in
	  k) keyword=${OPTARG};;
...
if [ "$shortmode" ]; then 
	echo "shortmode tests = enabled" |tee -a $report 2>/dev/null
else 
	echo "shortmode tests = disabled" |tee -a $report 2>/dev/null
fi
...
echo -e "\e[00;33m### TOP ##########################################\e[00m" |tee -a $report 2>/dev/null

top_info=`top -n 1 2>/dev/null`
if [ "$top_info" ]; then
  echo -e "\e[00;31mCurrent memory info:\e[00m\n$top_info" |tee -a $report 2>/dev/null
  echo -e "\n" |tee -a $report 2>/dev/null
else 
  :
fi

echo -e "\e[00;33m### MEMORY ##########################################\e[00m" |tee -a $report 2>/dev/null

current_memoryinfo=`free -m 2>/dev/null`
if [ "$current_memoryinfo" ]; then
  echo -e "\e[00;31mCurrent memory info:\e[00m\n$current_memoryinfo" |tee -a $report 2>/dev/null
  echo -e "\n" |tee -a $report 2>/dev/null
else 
  :
fi

memoryinfo=`cat /proc/meminfo 2>/dev/null`
if [ "$memoryinfo" ]; then
  echo -e "\e[00;31m/proc/meminfo:\e[00m\n$memoryinfo" |tee -a $report 2>/dev/null
  echo -e "\n" |tee -a $report 2>/dev/null
else 
  :
fi

echo -e "\e[00;33m### FS SYSTEM##########################################\e[00m" |tee -a $report 2>/dev/null

df_info=`df -h 2>/dev/null`
if [ "$df_info" ]; then
  echo -e "\e[00;31mdf:\e[00m\n$df_info" |tee -a $report 2>/dev/null
  echo -e "\n" |tee -a $report 2>/dev/null
else 
  :
fi
...
if [ "$mount_info" ]; then
  echo -e "\e[00;31mMount info:\e[00m\n$mount_info" |tee -a $report 2>/dev/null
  echo -e "\n" |tee -a $report 2>/dev/null
else 
  :
fi
...
echo -e "\e[00;33m### MOUDLES #######################################\e[00m" |tee -a $report 2>/dev/null
modules_info=`lsmod 2>/dev/null`
if [ "$modules_info" ]; then
  echo -e "\e[00;31modules information:\e[00m\n$modules_info" |tee -a $report 2>/dev/null
  echo -e "\n" |tee -a $report 2>/dev/null
else 
  :
fi

echo -e "\e[00;33m### LOGGINE #######################################\e[00m" |tee -a $report 2>/dev/null

dmesg_info=`dmesg 2>/dev/null`
if [ "$dmesg_info" ]; then
  echo -e "\e[00;31mdmesg information:\e[00m\n$dmesg_info" |tee -a $report 2>/dev/null
  echo -e "\n" |tee -a $report 2>/dev/null
else 
  :
fi
